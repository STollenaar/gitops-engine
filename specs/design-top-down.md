...
- Argo CD controller will be moved to https://github.com/STollenaar/gitops-engine.
- Flux will import GitOps engine component from the https://github.com/STollenaar/gitops-engine repository and use it to perform cluster state syncing.
